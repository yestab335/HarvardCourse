...
def category(request, name):
  ...
  auctions = Auction.objects.filter(category=category, ended_manually=False, end_time__gte=datetime.now())
  return render(request, "auctoins/auction_list.html", {
    "auction": auctions,
    "title": category.name
  })
